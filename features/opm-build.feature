...
Сценарий: Сборка, установка и выполнение пакета
    ...
    Тогда файл "oscript_modules/vanessa-support/src/main.os" существует
    Тогда я выполняю команду получения версии установленного пакета "oscript oscript_modules/vanessa-support/src/main.os --version"
